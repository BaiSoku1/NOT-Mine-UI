        ...
        {"MainModule"},
        {
            ...
            },
            {
                ...
                {"Components"},
                {
                    ...
                    {59, "ModuleScript", {"MultiSection"}} -- Added MultiSection component
                }
            }
        }
    }
...
local aa = {
    ...
    [54] = function()
        ...
        return {
            Name = "Crimson",
            Accent = Color3.fromRGB(159, 0, 0),
            AcrylicMain = Color3.fromRGB(71, 0, 0),
            AcrylicBorder = Color3.fromRGB(120, 0, 0),
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(99, 0, 0), Color3.fromRGB(71, 0, 0)),
            AcrylicNoise = 0.9,
            TitleBarLine = Color3.fromRGB(141, 0, 0),
            Tab = Color3.fromRGB(99, 0, 0),
            Element = Color3.fromRGB(99, 0, 0),
            ElementBorder = Color3.fromRGB(71, 0, 0),
            InElementBorder = Color3.fromRGB(120, 0, 0),
            ElementTransparency = 0.9,
            ToggleSlider = Color3.fromRGB(141, 0, 0),
            ToggleToggled = Color3.fromRGB(0, 0, 0),
            SliderRail = Color3.fromRGB(120, 0, 0),
            DropdownFrame = Color3.fromRGB(120, 0, 0),
            DropdownHolder = Color3.fromRGB(71, 0, 0),
            DropdownBorder = Color3.fromRGB(71, 0, 0),
            DropdownOption = Color3.fromRGB(159, 0, 0),
            Keybind = Color3.fromRGB(99, 0, 0),
            Input = Color3.fromRGB(120, 0, 0),
            InputFocused = Color3.fromRGB(71, 0, 0),
            InputIndicator = Color3.fromRGB(159, 0, 0),
            Dialog = Color3.fromRGB(71, 0, 0),
            DialogHolder = Color3.fromRGB(71, 0, 0),
            DialogHolderLine = Color3.fromRGB(99, 0, 0),
            DialogButton = Color3.fromRGB(99, 0, 0),
            DialogButtonBorder = Color3.fromRGB(120, 0, 0),
            DialogBorder = Color3.fromRGB(120, 0, 0),
            DialogInput = Color3.fromRGB(120, 0, 0),
            DialogInputLine = Color3.fromRGB(159, 0, 0),
            Text = Color3.fromRGB(240, 240, 240),
            SubText = Color3.fromRGB(170, 170, 170),
            Hover = Color3.fromRGB(159, 0, 0),
            HoverChange = 0.05,
            ShineEnabled = getgenv().ShineEnabled,
            Shine = {
                Speed = 0.5,
            ...
            StrokeShine = getgenv().ShineEnabled,
            StrokeDark = Color3.fromRGB(120, 0, 0),
            ButtonGradient = {
                Background = ColorSequence.new(
                    {
    ...
    [58] = function()
        ...
        return {
            Name = "Neon",
            Accent = Color3.fromRGB(171, 32, 253),
            AcrylicMain = Color3.fromRGB(0, 0, 0),
            AcrylicBorder = Color3.fromRGB(125, 18, 255),
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(0, 0, 0), Color3.fromRGB(32, 5, 137)),
            AcrylicNoise = 0.9,
            TitleBarLine = Color3.fromRGB(171, 32, 253),
            Tab = Color3.fromRGB(125, 18, 255),
            Element = Color3.fromRGB(125, 18, 255),
            ElementBorder = Color3.fromRGB(32, 5, 137),
            InElementBorder = Color3.fromRGB(171, 32, 253),
            ElementTransparency = 0.87,
            ToggleSlider = Color3.fromRGB(125, 18, 255),
            ToggleToggled = Color3.fromRGB(10, 0, 30),
            SliderRail = Color3.fromRGB(125, 18, 255),
            DropdownFrame = Color3.fromRGB(251, 248, 253),
            DropdownHolder = Color3.fromRGB(10, 0, 30),
            DropdownBorder = Color3.fromRGB(32, 5, 137),
            DropdownOption = Color3.fromRGB(125, 18, 255),
            Keybind = Color3.fromRGB(125, 18, 255),
            Input = Color3.fromRGB(251, 248, 253),
            InputFocused = Color3.fromRGB(20, 0, 40),
            InputIndicator = Color3.fromRGB(171, 32, 253),
            Dialog = Color3.fromRGB(10, 0, 30),
            DialogHolder = Color3.fromRGB(5, 0, 20),
            DialogHolderLine = Color3.fromRGB(5, 0, 15),
            DialogButton = Color3.fromRGB(10, 0, 30),
            DialogButtonBorder = Color3.fromRGB(125, 18, 255),
            DialogBorder = Color3.fromRGB(32, 5, 137),
            DialogInput = Color3.fromRGB(20, 0, 50),
            DialogInputLine = Color3.fromRGB(171, 32, 253),
            Text = Color3.fromRGB(251, 248, 253),
            SubText = Color3.fromRGB(200, 180, 255),
            Hover = Color3.fromRGB(125, 18, 255),
            HoverChange = 0.07,
            ShineEnabled = getgenv().ShineEnabled,
            Shine = {
                Speed = 0.4,
            ...
            StrokeShine = getgenv().ShineEnabled,
            StrokeDark = Color3.fromRGB(32, 5, 137),
            ButtonGradient = {
                Background = ColorSequence.new(
                    {
    ...
    [59] = function() -- MultiSection Component
        local c, d, e, f, g = b(59)
        local h = d.Parent.Parent
        local i, j = e(h.Creator), e(h.Packages.Flipper)
        local k, l, m = i.New, j.Spring.new, i.SpringMotor
        
        local function IsPressInput(n)
            return n.UserInputType == Enum.UserInputType.MouseButton1 or n.UserInputType == Enum.UserInputType.Touch
        end
        
        local function ResolveTransparency(n, o)
            local p = i.GetThemeProperty(n, i.Theme)
        ...
        return function(n, o)
            local p = {
                ...
                Desc = o.Desc,
                Icon = o.Icon,
                TextXAlignment = o.TextXAlignment or "Left",
                TextSize = o.TextSize or 19,
                DescTextSize = o.DescTextSize or 16,
                Box = o.Box or false,
                BoxBorder = o.BoxBorder or false,
                FontWeight = o.FontWeight or Enum.FontWeight.SemiBold,
                DescFontWeight = o.DescFontWeight or Enum.FontWeight.Medium,
                TextTransparency = o.TextTransparency or 0.05,
                DescTextTransparency = o.DescTextTransparency or 0.4,
                HoverFeedback = o.Hover ~= false,
                Opened = o.Opened or false,
                Locked = o.Locked or false,
                LockedTitle = o.LockedTitle,
                UIElements = {},
                
                HeaderSize = o.HeaderSize or 42,
                IconSize = o.IconSize or 20,
                HeaderGap = o.HeaderGap or 10,
                HeaderPaddingX = o.HeaderPaddingX or (o.Window.ElementConfig.UIPadding + (o.Window.ModernLayout and 4 or 2)),
                HeaderPaddingY = o.HeaderPaddingY or math.max(math.floor((o.Window.ElementConfig.UIPadding + (o.Window.ModernLayout and 4 or 0)) * 0.65), 6),
                
                TabGap = o.TabGap or 6,
                TabPaddingX = o.TabPaddingX or 12,
                TabPaddingY = o.TabPaddingY or 8,
                TabTextSize = o.TabTextSize or 15,
                TabDescTextSize = o.TabDescTextSize or 13,
            ...
            local q, r, s, t, u, v
            local w = o.Tab and o.Tab.UIElements and o.Tab.UIElements.ContainerFrame
            
            local x = "__windui_multisection_scroll_lock_count"
            local y = "__windui_multisection_scroll_lock_restore"
            
            local function GetUIScale()
                local z = tonumber((o.WindUI and o.WindUI.UIScale) or o.UIScale) or 1
                if z <= 0 then
                    return 1
                end
                return z
            ...
            local function ToLayoutOffset(z)
                return z / GetUIScale()
            end
            
            local function createTitle(z, A)
                return k("TextLabel", {
                    BackgroundTransparency = 1,
                    TextXAlignment = p.TextXAlignment,
                    AutomaticSize = "Y",
                    TextSize = A and p.DescTextSize or p.TextSize,
                    TextTransparency = A and p.DescTextTransparency or p.TextTransparency,
                    ThemeTag = {
                        TextColor3 = A and "SectionDesc" or "SectionTitle",
                    },
                    FontFace = Font.new(i.Font, A and p.DescFontWeight or p.FontWeight),
                    Text = z,
                    Size = UDim2.new(1, 0, 0, 0),
                    TextWrapped = true,
                })
            ...
            local z = k("Frame", {
                ...
                k("UIListLayout", {
                    ...
                    HorizontalAlignment = p.TextXAlignment,
                    VerticalAlignment = "Center",
                    Padding = UDim.new(0, 4),
                }),
            })
            
            local A = createTitle(p.Title, false)
            A.Parent = z
            
            local B
            if p.Desc and p.Desc ~= "" then
                B = createTitle(p.Desc, true)
                B.Parent = z
            end
            
            local C = k("Frame", {
                Size = UDim2.new(0, p.IconSize, 0, p.IconSize),
                BackgroundTransparency = 1,
                Visible = false,
            }, {
                k("ImageLabel", {
                    ...
                    BackgroundTransparency = 1,
                    Image = i.Icon("chevron-down")[1],
                    ImageRectSize = i.Icon("chevron-down")[2].ImageRectSize,
                    ImageRectOffset = i.Icon("chevron-down")[2].ImageRectPosition,
                    ThemeTag = {
            ...
            local D = k("Frame", {
                Size = UDim2.new(0, 0, 0, p.IconSize),
                AutomaticSize = "X",
                BackgroundTransparency = 1,
            }, {
                k("UIListLayout", {
            ...
            local E = k("Frame", {
                ...
                k("UIListLayout", {
                    Padding = UDim.new(0, p.HeaderGap),
                    FillDirection = "Horizontal",
                    VerticalAlignment = "Center",
            ...
            local F = k("Frame", {
                Name = "IconContainer",
                Size = UDim2.new(0, p.IconSize + 10, 0, p.IconSize + 10),
                BackgroundTransparency = 1,
                Visible = false,
            })
            q = F
            ...
            local G = k("Frame", {
                ...
                ImageTransparency = not p.Box and 1 or nil,
            }, {
                k("UIListLayout", {FillDirection = "Vertical"}),
                k("TextButton", {
                    Name = "Top",
                    Size = UDim2.new(1, 0, 0, p.HeaderSize),
                    AutomaticSize = "Y",
                    BackgroundTransparency = 1,
                    Active = false,
                    AutoButtonColor = false,
                    ...
                    k("UIPadding", {
                        PaddingTop = UDim.new(0, p.HeaderPaddingY),
                        PaddingBottom = UDim.new(0, p.HeaderPaddingY),
                        PaddingLeft = UDim.new(0, p.HeaderPaddingX),
                        PaddingRight = UDim.new(0, p.HeaderPaddingX),
                    }),
                    E,
                }),
                k("Frame", {
                    Name = "HeaderDivider",
                    BackgroundTransparency = 1,
                    Size = UDim2.new(1, -(p.Box and o.Window.ElementConfig.UIPadding * 2 or 0), 0, 1),
                    Position = UDim2.new(0.5, 0, 0, p.HeaderSize),
                ...
                k("Frame", {
                    ...
                    AutomaticSize = "Y",
                    Visible = false,
                    Position = UDim2.new(0, 0, 0, p.HeaderSize),
                }, {
                    k("UIPadding", {
                        PaddingTop = UDim.new(0, p.Box and 8 or 4),
                        PaddingLeft = UDim.new(0, p.Box and o.Window.ElementConfig.UIPadding or 0),
                        PaddingRight = UDim.new(0, p.Box and o.Window.ElementConfig.UIPadding or 0),
                        PaddingBottom = UDim.new(0, p.Box and o.Window.ElementConfig.UIPadding or 2),
                    }),
                    k("UIListLayout", {
                        FillDirection = "Vertical",
                        Padding = UDim.new(0, p.TabGap),
            ...
            p.UIElements = {
                ...
                Content = G.Content,
                Tabs = G.Content.Tabs,
                TabsScroll = G.Content.Tabs.Scroll,
                TabsContent = G.Content.TabsContent,
                Icon = F,
                Title = A,
                Desc = B,
                Chevron = C.ImageLabel,
            }
            
            local H = G.Content.Tabs.Scroll.UIListLayout
            
            local function UpdateTitleSize()
                local I = F.Visible and (ToLayoutOffset(F.AbsoluteSize.X) + p.HeaderGap) or 0
                local J = D.AbsoluteSize.X > 0 and (ToLayoutOffset(D.AbsoluteSize.X) + p.HeaderGap) or 0
                z.Size = UDim2.new(1, -(I + J), 0, 0)
            end
            
            local function SetWindowScrollLock(I)
                if not w then
                    u = false
                    return
                end
                ...
                if I and not u then
                    ...
                    local J = w:GetAttribute(x) or 0
                    if J <= 0 then
                        w:SetAttribute(y, w.ScrollingEnabled)
                    end
                    
                    w:SetAttribute(x, J + 1)
                    w.ScrollingEnabled = false
                    return
                end
                ...
                if (not I) and u then
                    ...
                    local K = w:GetAttribute(y)
                    w:SetAttribute(x, nil)
                    w:SetAttribute(y, nil)
                    w.ScrollingEnabled = typeof(K) == "boolean" and K or true
                end
            end
            
            local function UpdateWindowScrollLock()
                local I = s and t and p.Opened and not p.Locked
                SetWindowScrollLock(I)
            end
            
            local function UpdateTabsAlignment()
                local I = p.UIElements.Tabs
                local J = p.UIElements.TabsScroll
                
                local K = math.max(0, math.floor(ToLayoutOffset(J.AbsoluteSize.X) + 0.5))
                local L = math.max(0, math.floor(ToLayoutOffset(H.AbsoluteContentSize.X) + 0.5))
                local M = math.max(0, math.floor(ToLayoutOffset(H.AbsoluteContentSize.Y) + 0.5))
                local N = math.max(p.TabTextSize + (p.TabPaddingY * 2), 20)
                local O = (#p.Tabs > 0) and math.max(math.ceil(M), N) or 0
                
                I.Size = UDim2.new(1, 0, 0, O)
                J.Size = UDim2.new(1, 0, 0, O)
                J.CanvasSize = UDim2.new(0, math.max(L, K), 0, O)
                
                if K <= 0 or L <= 0 then
                    t = false
                    H.HorizontalAlignment = Enum.HorizontalAlignment.Left
                    J.ScrollingEnabled = false
                ...
                if L <= K then
                    ...
                    H.HorizontalAlignment = Enum.HorizontalAlignment.Left
                    J.ScrollingEnabled = true
                    
                    local P = math.max(J.AbsoluteCanvasSize.X - J.AbsoluteSize.X, 0)
                    local Q = math.clamp(J.CanvasPosition.X, 0, P)
                    
                    if Q ~= J.CanvasPosition.X then
                        J.CanvasPosition = Vector2.new(Q, 0)
                    end
                end
            ...
            local function UpdateContentLayout()
                local I = G.Top.AbsoluteSize.Y / GetUIScale()
                G.Content.Position = UDim2.new(0, 0, 0, I)
                G.HeaderDivider.Position = UDim2.new(0.5, 0, 0, I)
            end
            
            local function SetHoverState(I)
                if not p.Box then
                    return
                end
                
                local J = ResolveTransparency("SectionBoxBackgroundTransparency", 0.95)
                local K = math.max(J - 0.04, 0)
                local L = math.max(J - 0.1, 0)
            ...
            local function SetChevronState(I, J)
                local K = I and 180 or 0
                local L = I and 0.1 or 0.25
                
                if J then
                    C.ImageLabel.Rotation = K
                    C.ImageLabel.ImageTransparency = L
                else
                    j.Tween(C.ImageLabel, 0.2, {
                        Rotation = K,
                        ImageTransparency = L,
                    }, Enum.EasingStyle.Quint, Enum.EasingDirection.Out):Play()
                end
            ...
            local function SyncHeight(I)
                if not p.Expandable then
                    return
                end
                ...
                local J = G.Top.AbsoluteSize.Y
                local K = p.Opened and G.Content.AbsoluteSize.Y or 0
                local L = (J + K) / GetUIScale()
                
                local M = UDim2.new(G.Size.X.Scale, G.Size.X.Offset, 0, L)
                
                if I then
                    G.Size = M
                else
                    j.Tween(G, p.Opened and 0.33 or 0.24, {
                        Size = M,
                    }, Enum.EasingStyle.Quint, Enum.EasingDirection.Out):Play()
                end
                
                G.HeaderDivider.Visible = p.Opened and p.Box and G.Content.AbsoluteSize.Y > 0
            end
            
            local function EnsureExpandable()
                if p.Expandable then
                    return
                end
                
                p.Expandable = true
                C.Visible = true
                G.Top.Active = not p.Locked
                G.Content.Visible = true
            ...
            local function SetTabState(I, J, K)
                if not I or not I.UIElements or not I.UIElements.Button then
                    return
                end
                ...
                local Q = I.UIElements.Button
                local R = I.UIElements.Outline
                local S = I.UIElements.Title
                local T = I.UIElements.Desc
                local U = I.UIElements.Icon and I.UIElements.Icon.ImageLabel
                
                if K then
                    Q.ImageTransparency = L
                    if R then
                        R.ImageTransparency = M
                    end
                    if S then
                        S.TextTransparency = N
                    end
                    if T then
                        T.TextTransparency = O
                    end
                    if U then
                        U.ImageTransparency = P
                    end
                else
                    j.Tween(Q, 0.1, {
                        ImageTransparency = L,
            ...
            local function SetTabElementsLocked(I)
                for J, K in next, p.Tabs do
                    if K and K.Elements then
                        for L, M in next, K.Elements do
                            if I then
            ...
            function p.SetIcon(I, J)
                ...
                if J then
                    ...
                    q.Size = UDim2.new(0, p.IconSize, 0, p.IconSize)
                    q.Parent = F
            ...
            function p.SetTitle(I, J)
                p.Title = J
                A.Text = J
            end
            
            function p.SetDesc(I, J)
                p.Desc = J
                
                if J and J ~= "" then
                    if not B then
                        B = createTitle(J, true)
                        B.Parent = z
                        p.UIElements.Desc = B
                    end
                    B.Text = J
            ...
            function p.SelectTab(I, J, K)
                local L = ResolveTab(J)
                if not L then
                    return nil
                end
                
                if p.SelectedTab == L then
                    return L
                end
                
                if p.SelectedTab and p.SelectedTab.UIElements.Content then
                    p.SelectedTab.UIElements.Content.Parent = nil
                    SetTabState(p.SelectedTab, "Default", K)
                end
                
                p.SelectedTab = L
                p.SelectedTabIndex = L.Index
                
                L.UIElements.Content.Parent = p.UIElements.TabsContent
                SetTabState(L, "Selected", K)
                
                SyncHeight(K)
                return L
            end
            
            function p.GetSelectedTab(I)
                return p.SelectedTab
            end
            
            function p.GetTabs(I)
                return p.Tabs
            end
            ...
            function p.Tab(I, J)
                ...
                local K = {
                    ...
                    Title = J.Title or ("Tab " .. tostring(#p.Tabs + 1)),
                    Desc = J.Desc,
                    Icon = J.Icon,
                    ...
                    UIElements = {},
                    Index = #p.Tabs + 1,
                    Gap = o.Tab and o.Tab.Gap or (o.Window.ModernLayout and (o.Window.ModernLayoutMergeElements == false and 4 or 1) or 6),
                }
                ...
                local M = K.Desc and K.Desc ~= ""
                local N = M and "Left" or "Center"
                local O = L and 24 or 0
                
                local P = M and k("TextLabel", {
                    Name = "Desc",
                    BackgroundTransparency = 1,
                    AutomaticSize = "XY",
                    Text = K.Desc or "",
                    ...
                    FontFace = Font.new(i.Font, Enum.FontWeight.Regular),
                    TextSize = p.TabDescTextSize,
                    TextTransparency = 0.6,
                }, {
                    k("UIPadding", {
                        PaddingLeft = UDim.new(0, O),
                    }),
                }) or nil
                
                local Q = k("TextButton", {
                    Size = UDim2.new(0, 0, 0, 0),
                    AutomaticSize = "XY",
                    BackgroundTransparency = 1,
                    AutoButtonColor = false,
                    Parent = p.UIElements.TabsScroll,
                    ThemeTag = {
                    ...
                    k("Frame", {
                        ...
                        k("UIPadding", {
                            PaddingTop = UDim.new(0, p.TabPaddingY),
                            PaddingBottom = UDim.new(0, p.TabPaddingY),
                            PaddingLeft = UDim.new(0, p.TabPaddingX),
                            PaddingRight = UDim.new(0, p.TabPaddingX),
                        }),
                        k("UIListLayout", {
                            FillDirection = "Vertical",
                ...
                local R = k("Frame", {
                    Name = "TabContent_" .. tostring(K.Index),
                    Size = UDim2.new(1, 0, 0, 0),
                    AutomaticSize = "Y",
                    BackgroundTransparency = 1,
                }, {
                ...
                K.UIElements = {
                    Button = Q,
                    Outline = Q.UIStroke,
                    Title = Q.Frame.HeaderRow.Title,
                    Desc = P,
                    Icon = L,
                    Content = R,
                    ContainerFrame = (o.Tab and o.Tab.UIElements and o.Tab.UIElements.ContainerFrame) or {ScrollingEnabled = true},
                }
                
                local S = o.ElementsModule
                ...
                S.Load(
                    ...
                    o.WindUI,
                    function(T)
                        if p.Locked and T and T.Lock then
                            T:Lock()
                        end
                        
                        if p.SelectedTab == K and p.Expandable then
                            SyncHeight(true)
                        end
                    end,
                    S,
                ...
                i.AddSignal(R.UIListLayout:GetPropertyChangedSignal("AbsoluteContentSize"), function()
                    if p.SelectedTab == K and p.Expandable then
                        SyncHeight(true)
                    end
                end)
                
                i.AddSignal(Q.MouseEnter, function()
                    if p.Locked then
                        return
                    end
                    
                    if p.SelectedTab ~= K then
                        SetTabState(K, "Hover", false)
                    end
                end)
                
                i.AddSignal(Q.InputEnded, function()
                    if p.Locked then
                        return
                    end
                    
                    if p.SelectedTab ~= K then
                        SetTabState(K, "Default", false)
                    end
                end)
                
                i.AddSignal(Q.MouseButton1Click, function()
                    if p.Locked then
                        return
                    end
                ...
                function K.Select(T, U)
                    return p:SelectTab(K, U)
                end
                
                function K.Destroy(T)
                    for U = #K.Elements, 1, -1 do
                        local V = K.Elements[U]
                        if V and V.Destroy then
                            V:Destroy()
                        end
                    end
                    
                    if K.UIElements.Content then
                        K.UIElements.Content:Destroy()
                    end
                    
                    if K.UIElements.Button then
                        K.UIElements.Button:Destroy()
                    end
                    
                    local U
                    for V, W in next, p.Tabs do
                        if W == K then
                            U = V
                            break
                        end
                    ...
                    if p.SelectedTab == K then
                        p.SelectedTab = nil
                        p.SelectedTabIndex = nil
                        
                        if p.Tabs[1] then
                            p:SelectTab(p.Tabs[1], true)
                        else
                            SyncHeight(true)
                        end
                    else
                ...
                table.insert(p.Tabs, K)
                UpdateTabsAlignment()
                
                if J.Selected or J.Opened or not p.SelectedTab then
                    p:SelectTab(K, true)
                else
                    SetTabState(K, "Default", true)
                end
            ...
            function p.Open(I, J)
                if p.Expandable then
                    p.Opened = true
                    G.Content.Visible = true
                    SetChevronState(true, J)
                    SyncHeight(J)
                    UpdateWindowScrollLock()
                end
            end
            
            function p.Close(I, J)
                if p.Expandable then
                    p.Opened = false
                    SetChevronState(false, J)
                    SyncHeight(J)
                    UpdateWindowScrollLock()
                end
            end
            ...
            i.AddSignal(G.Top:GetPropertyChangedSignal("AbsoluteSize"), function()
                UpdateTitleSize()
                UpdateContentLayout()
            ...
            i.AddSignal(D:GetPropertyChangedSignal("AbsoluteSize"), function()
                UpdateTitleSize()
            end)
            
            i.AddSignal(G.Content.UIListLayout:GetPropertyChangedSignal("AbsoluteContentSize"), function()
                if p.Expandable then
                    SyncHeight(true)
                end
            end)
            
            i.AddSignal(p.UIElements.TabsScroll:GetPropertyChangedSignal("AbsoluteSize"), function()
                UpdateTabsAlignment()
            end)
            
            i.AddSignal(H:GetPropertyChangedSignal("AbsoluteContentSize"), function()
                UpdateTabsAlignment()
            end)
            
            i.AddSignal(p.UIElements.TabsScroll.MouseEnter, function()
                if p.Locked then
                    return
                end
            ...
            i.AddSignal(p.UIElements.TabsScroll.MouseLeave, function()
                s = false
                UpdateWindowScrollLock()
            end)
            
            i.AddSignal(j.UserInputService.InputChanged, function(I)
                if p.Locked then
                    return
                end
                ...
                local J = p.UIElements.TabsScroll
                local K = math.max(J.AbsoluteCanvasSize.X - J.AbsoluteSize.X, 0)
                if K <= 0 then
                    return
                end
                
                local L = -I.Position.Z * 34
                local M = math.clamp(J.CanvasPosition.X + L, 0, K)
                J.CanvasPosition = Vector2.new(M, 0)
            end)
            
            i.AddSignal(G.Top.MouseEnter, function()
                if not p.HoverFeedback or p.Locked then
                    return
                end
            ...
            i.AddSignal(G.Top.MouseLeave, function()
                q = false
                r = false
                SetHoverState(false)
            end)
            
            i.AddSignal(G.Top.InputBegan, function(I)
                if not p.HoverFeedback or p.Locked or not IsPressInput(I) then
                    return
                end
            ...
            i.AddSignal(G.Top.InputEnded, function(I)
                if not p.HoverFeedback or p.Locked or not IsPressInput(I) then
                    return
                end
            ...
            i.AddSignal(G.Top.Activated, function()
                if p.Locked then
                    return
                end
            ...
            task.defer(function()
                ...
                if not p.Expandable then
                    G.Content.Visible = false
                    G.Top.Active = false
                    G.Top.Size = UDim2.new(1, 0, 0, p.HeaderSize)
                    G.Top.AutomaticSize = "Y"
                    G.AutomaticSize = "Y"
                end
                
                SetHoverState(true)
                SetChevronState(p.Opened, true)
